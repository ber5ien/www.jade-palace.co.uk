	...
	public function addAccount($checkemailflag,$email,$password1,$name,$surname,$number,$region){
		...
		{	
			...
			if($mysqli->affected_rows > 0 )
			{
				...
				$message = "
				Welcome on Golden Dragon Website. You are now able to get exclusive offer and discounts throught our website.
				These are the details you are provided to us:
				Your email: ".$email."
				...
				Enjoy our food and service!
				";
				$result=mail($email,'Golden Dragon account confirmation.',$message);
				if($result)
				{

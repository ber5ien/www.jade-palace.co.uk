...
$category = $_GET['cat'];
	...
	echo ("<table id=menu_table style='empty-cells: hide' border=1 width=100% bgcolor=white cellpadding=5 cellspacing=11>");
	echo ("<tr><td></td><td style='border: none;'><center><h1>Special Dishes</h1></center></td><td></td></tr>");

...
if ( isset($_GET['create']) && $_GET['create']==1)
{
	...
	{
		 echo "
	 	<font color=white size=4>You must choose your shop region. Press back button in your browser.</font><br>
	 ";
	}elseif( strlen($_POST['password'])<= 0 )
	{
			 echo "
	 		<font color=white size=4>You must fill out all your detail. Press back button in your browser.</font><br>
	 		";
	 }elseif( $_POST['password'] != $_POST['repassword'] )
	 {
		 echo "
		 	<font color=white size=4>Your password doesn't match. Type passwords again and click button again.</font><br><br>
	 	";
		...
		<tr><td></td><td><input class=button type=submit value='CLICK ME TO COMPLETE ME.'></td></tr>
		</form>
		</table>
		</font>
	 	";
	...
	echo " <font color=white size=4>Your account has not been created. Please fill out the form correctly.</font><br>";
	}
...
<select class="required" name=region><OPTION value="">Choose your region</option><option>St.Austell</option><option>Roche</option><option>Truro</option></select><br></td></tr>
<tr><td></td><td><input class=button type=submit value="CLICK ME TO COMPLETE ME."></td></tr>
</form>

...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'common/viewsource_all.tpl', 2, false),array('function', 'counter', 'common/viewsource_all.tpl', 4, false),)), $this); ?>
...
&amp;mod=view_world_map<?php if ($this->_tpl_vars['map'] == 'continent'): ?>&amp;id_details_continent=<?php echo $this->_tpl_vars['continent_asked'];  endif; ?>" <?php if ($this->_tpl_vars['map'] == 'world'): ?>usemap="#worldmap"<?php endif; ?> class="generic" alt="map" />
<img src="<?php echo $this->_tpl_vars['path_maps']; ?>
/scale.png" class="detail" alt="" />
...
&amp;mod=view_graph&amp;graph_type=3&amp;graph_data=source_countries" alt="" />
</div>
<!-- Providers -->
<?php echo smarty_function_counter(array('name' => 'a'), $this);?>

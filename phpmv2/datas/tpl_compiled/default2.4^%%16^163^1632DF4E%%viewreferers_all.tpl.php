<?php /* Smarty version 2.6.9, created on 2010-08-09 14:17:13
         compiled from common/viewreferers_all.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'common/viewreferers_all.tpl', 2, false),array('function', 'counter', 'common/viewreferers_all.tpl', 4, false),)), $this); ?>
...
&amp;mod=view_graph&amp;graph_type=4&amp;graph_data=referers_summary" alt="" />
</div>
...
<?php $this->assign('strsites', ((is_array($_tmp='affluents_nbautressites')) ? $this->_run_mod_handler('translate', true, $_tmp, $this->_tpl_vars['numbers']['sites']) : smarty_modifier_translate($_tmp, $this->_tpl_vars['numbers']['sites'])));  $this->assign('strdistinctsites', ((is_array($_tmp='affluents_nbautressitesdiff')) ? $this->_run_mod_handler('translate', true, $_tmp, "<strong>".($this->_tpl_vars['numbers']['distinctsites'])."</strong>") : smarty_modifier_translate($_tmp, "<strong>".($this->_tpl_vars['numbers']['distinctsites'])."</strong>")));  
  /*** pmv_data_array ***/  
$_tplvars_stack_rank++;
 $_tplvars_stack[$_tplvars_stack_rank] = $this->_tpl_vars; 

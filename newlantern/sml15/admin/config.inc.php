...
$config['db_server'] = "chineselanterndb.db.6479645.hostedresource.com";

// A user that has access to your database
$config['db_user'] = "chineselanterndb";

// The password for the user that has access to your database
$config['db_password'] = "Maniak123";

// The name of the database
$config['db_name'] = "chineselanterndb";
...
$config['owner_email'] = "admin@chineselanterndb.co.uk";
